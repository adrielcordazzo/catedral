...
<div class="panel panel-default">
  <div class="panel-heading font-bold">Arquivo - <span rv-text="criado"> </span></div>
  <div class="panel-body">
    <form role="form">
      ...
      <div class="row">
        <div class="col-sm-6 form-group">
          <label>Nome:</label> 
          <input class="form-control data" placeholder="Nome" type="text" rv-value="nome">
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6 form-group">
          <label>Extensao:</label> 
          <input class="form-control data" placeholder="Extensao" type="text" rv-value="extensao">
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6 form-group">
          <label>Tipo:</label> 
          <input class="form-control data" placeholder="Tipo" type="text" rv-value="tipo">
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6 form-group">
          <label>Tamanho:</label> 
          <input class="form-control data" placeholder="Tamanho" type="text" rv-value="tamanho">
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6 form-group">
          <label>Arquivo:</label> 
          <input class="form-control data" placeholder="Arquivo" type="text" rv-value="arquivo">
        </div>
      </div>
      <div class="row">
