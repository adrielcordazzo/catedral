...
<div class="hbox hbox-auto-xs hbox-auto-sm" >
  <div class="col">
    <div class="bg-light lter b-b wrapper">
      <div class="row">
        <div class="col-sm-6 col-xs-12">
          <h1 class="m-n font-thin h3 text-black">Pasta</h1>
        </div>
      </div>
    </div>
    ...
    <div id="lista" class="panel panel-default">
      ...
      <td class="m-atualizado">Atualizado</td>
      <td class="m-inativo">Inativo</td>
      <td class="m-excluido">Excluido</td>
      <td class="m-idexterno">Idexterno</td>
      <td class="m-pasta">Pasta</td>
              <td>
