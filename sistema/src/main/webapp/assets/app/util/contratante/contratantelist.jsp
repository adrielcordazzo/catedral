    ...
    <div class="bg-light lter b-b wrapper">
      <div class="row">
        <div class="col-sm-6 col-xs-12">
          <h1 class="m-n font-thin h3 text-black">Contratante</h1>
        </div>
      </div>
    </div>
            ...
            <thead>
              ...
              <tbody>
                <tr class="model">
                  ...
                  <td class="m-datavendimento">{datavendimento}</td>
                  
                  <td class="m-responsavel">{responsavel}</td>
                  <td class="m-email">{email}</td>
