...
<div class="hbox hbox-auto-xs hbox-auto-sm" >
  <div class="col">
    <div class="bg-light lter b-b wrapper">
      <div class="row">
        <div class="col-sm-12 ">
          <h1 class="m-n font-thin h3 text-black pull-left">Campos para Configuração</h1>
          ...
          <table class="table table-striped b-t b-light">
            ...
            <tbody>
              <tr class="model">
                ...
                <td class="m-campo">{campo}</td>
                <td class="m-tipocampo">{tipocampo}</td>
                <td class="m-obrigatorio">{obrigatorio}</td>
                <td class="m-variavel">{variavel}</td>
                <td>
